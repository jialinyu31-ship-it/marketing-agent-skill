...
Use this file when the user's niche, product, client, or content request matches `高净值人群`. This is a synthesized playbook derived from the C-column Agent row `51: 高净值人群内容观点选题生成器` and its set attachment name `高净值人群内容观点选题生成器.md`. Do not copy the original source prompt text.
