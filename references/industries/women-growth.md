...
Use this file when the user's niche, product, client, or content request matches `女性成长`. This is a synthesized playbook derived from the C-column Agent row `33: 女性成长行业观点情绪选题生成器` and its set attachment name `女性成长行业观点情绪选题生成器.md`. Do not copy the original source prompt text.
