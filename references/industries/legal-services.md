...
Use this file when the user's niche, product, client, or content request matches `法律`. This is a synthesized playbook derived from the C-column Agent row `19: 法律行业观点情绪选题生成器` and its set attachment name `法律行业观点情绪选题生成器.md`. Do not copy the original source prompt text.
